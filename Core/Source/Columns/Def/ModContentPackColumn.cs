...
public sealed class ModContentPackColumn<TRecord>(ColumnDef columnDef) :
    Column<TRecord, ModContentPackColumn<TRecord>.ModContentPackCell>(columnDef, ColumnType.String)
        where TRecord :
            IDefTableRecord
{
