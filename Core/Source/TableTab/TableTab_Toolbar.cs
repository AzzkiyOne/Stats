...
public sealed partial class TableTab<TRecord>
{
    private sealed class Toolbar
    {
        ...
        public Toolbar(TableTab<TRecord> parent)
        {
            _parent = parent;
        ...
        {
            List<ColumnDef> compatibleColumns = _parent._columnDefs;
        ...
        private sealed class ColumnsFloatMenuOption : FloatMenuOption
        {
            ...
            public ColumnsFloatMenuOption(ColumnDef columnDef, TableTab<TRecord> parent)
