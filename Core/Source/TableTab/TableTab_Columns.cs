...
public sealed partial class TableTab<TRecord>
{
    ...
    private void AddColumn(ColumnDef columnDef)
    {
        ...
        _columns.Add(columnWrapper);
        _records.ForEach(column.NotifyRecordAdded);
        _toolbar.NotifyColumnAdded(columnWrapper);
    }
    ...
    private void RemoveColumn(ColumnWidget column)
    {
    ...
    private sealed class ColumnWidget
    {
        ...
        private readonly TableTab<TRecord> _parent;
        private readonly FloatMenu _menu;

        public ColumnWidget(Column<TRecord> column, TableTab<TRecord> parent)
        {
            ColumnDef def = column.Def;
        ...
        {
            bool shouldDrawCellsNow = _column.ShouldDrawCellsNow;
        ...
        private void DrawHeaderCell(Rect rect, bool mouseXIsInVisibleArea)
        {
            ...
            TableTab<TRecord> parent = _parent;
            ColumnType columnType = _column.Type;
        ...
        private void DoReorder(Rect rect, ColumnWidget reorderedColumn, bool mouseXIsInVisibleArea)
        {
            Event @event = Event.current;
            TableTab<TRecord> parent = _parent;
            ...
            {
                List<ColumnWidget> columns = parent._columns;
        ...
        {
            Width = Mathf.Max(_titleWidget.Size.x, _column.GetWidth(rows)) + GUIStyles.TableCell.PadHor * 2f;
        }
