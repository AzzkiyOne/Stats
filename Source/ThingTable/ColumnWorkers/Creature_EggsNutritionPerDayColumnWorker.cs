...
public sealed class Creature_EggsNutritionPerDayColumnWorker : NumberColumnWorker<ThingAlike>
{
    public Creature_EggsNutritionPerDayColumnWorker(ColumnDef columndef) : base(columndef, formatString: "0.00/d")
    {
    }
