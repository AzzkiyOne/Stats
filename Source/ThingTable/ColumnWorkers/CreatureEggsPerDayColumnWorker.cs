...
public sealed class CreatureEggsPerDayColumnWorker : NumberColumnWorker<ThingAlike>
{
    public CreatureEggsPerDayColumnWorker(ColumnDef columndef) : base(columndef, formatString: "0.0/d")
    {
    }
