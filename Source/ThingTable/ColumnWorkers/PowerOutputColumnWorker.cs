...
public sealed class PowerOutputColumnWorker : NumberColumnWorker<ThingAlike>
{
    public PowerOutputColumnWorker(ColumnDef columndef) : base(columndef, formatString: "0 W")
    {
    }
