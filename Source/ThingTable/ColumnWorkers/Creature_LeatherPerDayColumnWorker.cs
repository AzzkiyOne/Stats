...
public sealed class Creature_LeatherPerDayColumnWorker : NumberColumnWorker<ThingAlike>
{
    public Creature_LeatherPerDayColumnWorker(ColumnDef columndef) : base(columndef, formatString: "0.0/d")
    {
    }
